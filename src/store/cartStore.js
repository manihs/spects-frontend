        ...
        (set, get) => ({
            ...
            fetchCart: async () => {
                ...
                try {
                    ...
                    const { data, success, message } = await axiosInstance.get('/api/cart', {
                        headers: authHeaders
                    });
           ...
           // Replace the addItem function in your cartStore.js with this version
            ...
            updateItemQuantity: async (itemId, quantity) => {
                ...
                try {
                    ...
                    if (itemToUpdate.backendItemId) {
                        ...
                        const { data, success } = await axiosInstance.get('/api/cart', {
                            headers: authHeaders
                        });
            ...
            getTotals: () => {
                ...
                // Tax calculation (can be adjusted based on your requirements)
                const tax = subtotal * 0.1; // Example: 10% tax
                
                // Shipping calculation (can be adjusted based on your requirements)
